...
const API_URL = import.meta.env.VITE_API_URL || env.REACT_APP_API_URL || env.VITE_API_URL || nodeEnv.NEXT_PUBLIC_API_BASE_URL || nodeEnv.REACT_APP_API_URL || nodeEnv.API_BASE_URL || 'https://kid-backend.onrender.com/api/';
